...
CREATE TABLE SABORESDECASA.USUARIO(
...
ALTER TABLE SABORESDECASA.CLIENTE ADD CONSTRAINT FK_CLIENTE_USUARIO FOREIGN KEY (ID_USUARIO) REFERENCES SABORESDECASA.USUARIO(ID);
...
SELECT * FROM saboresdecasa.pedido p ;

SELECT * FROM saboresdecasa.usuario u ;
